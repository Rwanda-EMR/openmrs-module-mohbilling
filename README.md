...
See the [workflows defined here](https://github.com/Rwanda-EMR/openmrs-module-mohbilling/tree/master/.github/workflows) 
...
the [pom.xml](https://github.com/Rwanda-EMR/openmrs-module-mohbilling/blob/master/pom.xml)
...
curl  -H "Authorization: token $GITHUB_TOKEN" \
      ...
      https://api.github.com/repos/Rwanda-EMR/openmrs-module-mohbilling/dispatches
```
