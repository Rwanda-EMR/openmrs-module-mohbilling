...
//		BigDecimal qty = (BigDecimal.valueOf(quantity));
     ...
     *
     * @param bill the PatientBill to be saved
    ...
    public static PatientBill createPatientBill(BigDecimal totalAmount, InsurancePolicy ip) {
        ...
        BigDecimal pbAmount = totalAmount.multiply(BigDecimal.valueOf((rateToPay) / 100)).setScale(0, RoundingMode.HALF_UP);
     ...
     * which is its parent
     *
     * @param payment the BillPayment to be saved
     ...
     * general Total Bill.
     *
     * @param bill     the one to be refunded
     * @param services the ones to be removed
     ...
     * @param endDate   the ending period
