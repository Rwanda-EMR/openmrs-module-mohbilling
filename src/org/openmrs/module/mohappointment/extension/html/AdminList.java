...
public class AdminList extends AdministrationSectionExt {
	...
	public Map<String, String> getLinks() {
		...
		// map.put("module/mohappointment/mohappointmentForm.form",
		// "mohappointment.title");
		...
		// map.put("module/mohappointment/providerDashboard.form",
		// "mohappointment.appointment.provider.dashboard");
